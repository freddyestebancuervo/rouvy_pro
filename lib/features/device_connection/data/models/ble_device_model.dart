...
class BleDeviceModel extends BleDevice {
  ...
  factory BleDeviceModel.fromScanResult(ScanResult result) {
    final String advertisedName = result.advertisementData.advName.isNotEmpty
    ...
    return BleDeviceModel(
      ...
      rssi: result.rssi,
      compatibilityStatus: BleDeviceCompatibilityStatus.discovered,
    );
  }
