...
void main() {
  group('createAuthlessBackendDio', () {
    test('configura Dio con exactamente la baseUrl recibida, sin valor por defecto', () {
  ...
  group('createAuthenticatedBackendDio', () {
    test('configura Dio con exactamente la baseUrl recibida, sin valor por defecto', () {
      const String customUrl = 'https://custom-authenticated-backend.example/v1';
    ...
    test('adjunta el interceptor de autenticación', () {
      ...
      final dio = createAuthenticatedBackendDio(authService, 'https://x.example/v1');
